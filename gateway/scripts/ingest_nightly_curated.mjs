...
const OUT = process.env.CURATED_CACHE || path.join(__dirname, '..', 'tools', 'curated', 'cache', 'docs.jsonl');
const SEEDS = process.env.CURATED_SEEDS || path.join(__dirname, '..', 'tools', 'curated', 'seeds.json');
const REPLACE = String(process.env.CURATED_REPLACE || '1').toLowerCase() === '1';
