...
export const TrainLoopSchema = z.object({
...
// Forecasting schemas
export const ForecastSeedSchema = z.object({
  topic: z.string().min(1),
...
export const ForecastResolveSchema = z.object({
...
export const ForecastBacktestSeedSchema = z
  ...
  .refine(
    (d) =>
      Boolean(d.calendarText || (Array.isArray(d.events) && d.events.length)),
    {
